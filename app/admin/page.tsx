  ...
  return (
    <div className="admin-content">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 mb-8">
        {kpis.map((k, i) => (
          <div key={i} className="bg-white p-4 rounded-lg shadow-md border hover:shadow-lg">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
        <div className="bg-white rounded-lg p-4 shadow-md border">
          <h3 className="font-semibold text-[#012b73] mb-4">Category-wise Spend</h3>
        ...
        <div className="bg-white rounded-lg p-4 shadow-md border">
          <h3 className="font-semibold text-[#012b73] mb-4">Supplier Performance</h3>
          <ResponsiveContainer width="100%" height={220}>
      ...
      {/* AUCTIONS / PROPOSALS / POS */}
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">

        {/* Auctions */}
        <div className="bg-white rounded-lg p-4 shadow-md border">
          <h3 className="font-semibold text-[#012b73] mb-3">Auctions</h3>
          <div className="text-xs text-gray-500 mb-3">Live / Upcoming / Closed</div>
          ...
          {auctions.length === 0 ? (
            ...
            <div key={a.id} className="py-2 border-b flex justify-between">
              ...
              <div className="text-xs font-semibold text-right">
                ...
                {classifyAuction(a.start_at, a.end_at) === "Closed" && <span className="text-gray-500">Closed</span>}
              </div>
            </div>
          ))}
        </div>
        ...
        {/* Proposals */}
        <div className="bg-white rounded-lg p-4 shadow-md border">
          <h3 className="font-semibold text-[#012b73] mb-3">Proposals / Submissions</h3>
            ...
            <tbody>
              {proposals.map((p: any) => (
                <tr key={p.id} className="border-t">
                  <td className="py-2">{p.rfq_ref}</td>
        ...
        {/* Purchase Orders */}
        <div className="bg-white rounded-lg p-4 shadow-md border">
          <h3 className="font-semibold text-[#012b73] mb-3">Purchase Orders</h3>
          {purchaseOrders.map(po => (
            <div key={po.id} className="py-2 flex justify-between border-b">
              <div>
      ...
      {/* ACTIVITY */}
      <div className="bg-white rounded-lg p-4 shadow-md border mb-6">
        <h3 className="font-semibold text-[#012b73] mb-3">Recent activity</h3>
        {notifications.map(n => (
          <div key={n.id} className="py-2 border-b flex justify-between">
            <span>{n.message}</span>
      ...
      {/* MESSAGES */}
      <div className="bg-white rounded-lg p-4 shadow-md border mb-8">
        <h3 className="font-semibold text-[#012b73] mb-3">Messages</h3>
        {messages.map(m => (
